...
export default function Buttons() {
    ...
    const onClickTheme = () => changeTheme.change ? setChangeTheme({ icon: "moon", text: "Dark", change: false }) : setChangeTheme({ icon: "moon outline", text: "Light", change: true })
        ...
        <>
            <aside class="menu" className={styleButton.listButtons} >
                ...
                <ul className="menu-list">
                    ...
                    <li><button className={styleColor.buttonMenuBg} onClick={Profile}><Icon name='user circle' /><p>Profile</p></button></li>
                    <li><button className={styleColor.buttonMenuBg} onClick={handleLogout}><Icon name='power off' /><p>LogOut</p></button></li>
                </ul>
            </aside>
